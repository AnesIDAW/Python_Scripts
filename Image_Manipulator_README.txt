...
The Image Manipulation Script is a Python script that allows you to process a batch of images by resizing, rotating, and saving them in a specified format. It leverages the Pillow library for image processing and concurrent execution for faster processing.
...
1. **Clone the Repository**:
   ...
   ```bash
   git clone https://github.com/yourusername/image-manipulation-script.git
